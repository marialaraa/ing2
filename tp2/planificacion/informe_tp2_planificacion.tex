...
\begin{itemize}
\item Enviando Mensajes de campaña: Se refiere a la acción de enviar los mensajes que son definidos en la campaña. Los mismos podrán ser enviados como SMS o utilizando alguna de las redes sociales (Facebook, Twitter, etc.).   
\item Creando Campaña:
\item Creando Destinatario:
\end{itemize}
